...
public class TransportationController {
    ...
    public String updateTransportation(@PathVariable("id") int id, 
        ...
        if (existingTransportation.isPresent()) {
            Transportation currentTransportation = existingTransportation.get();
    
            // Set the existing ID to the transportation object
            ...
            if (image != null && !image.isEmpty()) {
                ...
                transportation.setImageUrl(currentTransportation.getImageUrl());
            }
    
            transportationService.updateTransportation(id, transportation);
            return "redirect:/transportation";
        } else {
            return "redirect:/transportation?error=notFound";
        }
